...
`
        ...
        return {
          ...
          content: `
# Jira 이슈 목록 (모의 응답)
APE-123: 명령어 파싱 버그 수정 (진행 중)
APE-122: 내부망/외부망 구성 분리 (완료)
APE-121: 모델 구성 관리 개선 (검토 중)
APE-120: 스트리밍 응답 처리 개선 (할 일)
`
        };
      } else {
        return {
...
// 테스트 목록
console.log('='.repeat(80));
console.log('APE 명령어 테스트 시작');
console.log('='.repeat(80));

// 일반 텍스트 테스트
testInput('안녕하세요, Ape입니다.');
